...
const App = () => {
  ...
  const capas = [
    ...
    { name: "camarasVecinales", label: "📹 Cámaras Vecinales", visible: capasVisibles.camarasVecinales },
    ...
    { name: "busquedaDirecciones", label: "🔍 Búsqueda de Direcciones", visible: capasVisibles.busquedaDirecciones },
    { name: "ubicadorPunto", label: "📍 Ubicador de Puntos", visible: capasVisibles.ubicadorPunto },
    { name: "coordenadasNuevas", label: "🔵 Coordenadas Nuevas", visible: capasVisibles.coordenadasNuevas },
    { name: "rutas", label: "🛣️ Calculador de Rutas", visible: capasVisibles.rutas },
    { name: "paraderosAutorizados", label: "🛵 Paraderos Autorizados", visible: capasVisibles.paraderosAutorizados },
    { name: "defensaCivil", label: "🏢 Defensa Civil", visible: capasVisibles.defensaCivil },
    { name: "paraderosNoAutorizados", label: "🚫 Paraderos No Autorizados", visible: capasVisibles.paraderosNoAutorizados },
  ...
  const mapCenter = [-11.9699, -76.9980];
  const mapZoom = 13.1;
  const mapStyle = { height: "100vh", width: "100%" };

  return (
    <>
      <LayerTogglePanel capas={capas} onToggle={handleToggle} mapType={mapType} onMapTypeChange={setMapType} />
      ...
      {mapType === 'leaflet' ? (
        ...
        >
          ...
          />
          <ClusterIncidencias visible={capasVisibles.clusters} radioCluster={radioCluster} filtros={payloadFiltros} />
        ...
        >
          ...
          <GoogleClusterIncidencias visible={capasVisibles.clusters} radioCluster={radioCluster} filtros={payloadFiltros} />
          ...
          />
          {/* TODO: Agregar más capas de Google Maps según sea necesario */}
        </GoogleMapWrapper>
      )}
