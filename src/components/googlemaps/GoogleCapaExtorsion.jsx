...
const GoogleCapaExtorsion = ({ visible, filtros = null, map, google }) => {
    ...
    return `
          <div style="font-size: 13px; max-width: 260px; position: relative;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px; border-bottom: 1px solid #eee; padding-bottom: 5px;">
              <strong style="color: #333;">📞 Extorsión</strong>
  ...
  }, [map, google, visible, extorsiones, currentZoom, calcularRadio, createInfoWindowContent, limpiarMarkers]);
